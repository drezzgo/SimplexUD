...
const resetCalculator = () => {
    ...
    clearOutput(output)
    alert("¡Calculadora restablecida correctamente!");
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.modal-background, .modal-close, .modal-card-head .delete, .modal-card-foot .button .bg-gray-100').forEach(($close) => {
